...
*/
-- AlterTable
ALTER TABLE `courses` MODIFY `active` BOOLEAN NOT NULL DEFAULT true,
...
-- AlterTable
ALTER TABLE `exams` MODIFY `active` BOOLEAN NOT NULL DEFAULT true,
    MODIFY `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    MODIFY `updatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
-- AlterTable
ALTER TABLE `tryout_sections` MODIFY `active` BOOLEAN NOT NULL DEFAULT true,
    MODIFY `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    MODIFY `updatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;

-- AlterTable
ALTER TABLE `users` MODIFY `active` BOOLEAN NOT NULL DEFAULT true,
    MODIFY `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    MODIFY `updatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
